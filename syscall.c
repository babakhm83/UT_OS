...
extern int sys_set_sjf_info(int,int,int); // Babak
extern int sys_set_queue(int,int); // Babak
...
static int (*syscalls[])(void) = {
    ...
    [SYS_set_sjf_info] sys_set_sjf_info, // Babak
    [SYS_set_queue] sys_set_queue, // Babak
